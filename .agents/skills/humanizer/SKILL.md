...
Source: https://raw.githubusercontent.com/blader/humanizer/main/SKILL.md
...
**Rule:** The final rewrite must not contain em dashes (—) or en dashes (–), unless the writer's
