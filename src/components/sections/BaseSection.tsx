    ...
    <section id="base" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-[var(--border-color)] scroll-mt-20">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <FadeInScroll direction="up" delay={0.2}>
          <div className="relative rounded-3xl bg-gradient-to-br from-[var(--bg-surface)] via-[var(--bg-surface-hover)] to-[var(--brand-blue-light)] border border-[var(--brand-blue)]/30 p-8 sm:p-12 shadow-2xl overflow-hidden text-center sm:text-left flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full lg:w-auto flex-shrink-0">
              <a
                ...
                className="w-full sm:w-auto px-8 py-5 rounded-2xl bg-emerald-500 hover:bg-emerald-600 active:scale-95 text-white font-extrabold text-base shadow-xl shadow-emerald-500/30 transition-all flex items-center justify-center space-x-3"
              >
